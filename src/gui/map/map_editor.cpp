...
void MapEditorController::createActions()
{
	...
	stretch_map_act = newAction("stretchmap", tr("Scale all objects..."), this, SLOT(stretchMapClicked()), "tool-scale.png", tr("Scale the whole map"), "map_menu.html");
        ...
        bool merge_duplicate_symbols)
{
	    ...
	    && other.getScaleDenominator() != map->getScaleDenominator())
	{
		...
		{
			other.changeScale(map->getScaleDenominator(), 1.0, MapCoord(0, 0), true, true, true, false, true);
		}
	}
