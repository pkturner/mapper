...
public:
	...
	enum UpdateOption
	{
		...
		/// Update grivation, combined scale factor, or projected reference point.
		UpdateGridParameter       = 1,
		
		/// Update declination, auxiliary scale factor, or geographic reference point.
	 ...
	 * scale factors.
	 */
	void setProjectedRefPoint(const QPointF& point, UpdateOption update_grivation = UpdateGridParameter,
													UpdateOption update_scale_factor = UpdateGridParameter);
	 ...
	 * scale factors.
	 */
	void setGeographicRefPoint(LatLon lat_lon, UpdateOption update_grivation = UpdateGridParameter,
											   UpdateOption update_scale_factor = UpdateGridParameter);
